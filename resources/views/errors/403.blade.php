...
<div class="text-center text-white p-4">
    ...
    <h1 class="fw-800 mt-3" style="font-size:4rem">403</h1>
    <h4 class="fw-600 mb-3">Akses Ditolak</h4>
    <p style="opacity:.8">{{ $exception->getMessage() ?: 'Anda tidak memiliki izin untuk mengakses halaman ini.' }}</p>
