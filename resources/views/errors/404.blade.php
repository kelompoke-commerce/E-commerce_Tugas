...
<div class="text-center text-white p-4">
    ...
    <h1 class="fw-800 mt-3" style="font-size:4rem">404</h1>
    <h4 class="fw-600 mb-3">Halaman Tidak Ditemukan</h4>
    <p style="opacity:.8">Sepertinya kopi yang kamu cari sudah habis... atau halamannya tidak ada.</p>
